    ...
    <style>
        ...
        * {
        ...
        @media (max-width: 768px) {
            ...
            .sejarah-grid, .visimisi-content, .produk-wrapper, .media-container { flex-direction: column; gap: 20px; }
            .hero h1 { font-size: 2rem; }
            .media-box.wood-frame { border-width: 6px; padding: 10px; }
        }
    </style>
</head>
<body>
        ...
        <div class="produk-wrapper">
            ...
            <div class="produk-detail">
                ...
                <div class="brosur-box">
                    <h4>Informasi Produk Lengkap</h4>
                    <p>Cangkir kami menggunakan bahan dasar bambu berkualitas dikombinasikan dengan gelas stainless di bagian dalam agar tetap steril, awet, dan mudah dibersihkan.</p>
                </div>
            </div>
        </div>
    </section>

    <section id="promosi" class="container">
        <div class="section-title">
            <h2>Media Promosi Digital</h2>
            <p>Informasi Brosur resmi dan Poster estetika produk kami</p>
        </div>
    ...
    <section id="dokumentasi" class="bg-cream">
        <div class="container">
            <div class="section-title">
                <h2>Dokumentasi & Galeri Proses</h2>
                <p>Langkah-langkah pembuatan Cangkir Bambu secara handmade</p>
            </div>
